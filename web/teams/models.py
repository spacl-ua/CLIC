...
class Team(AbstractUser):
        ...
        paperid = models.CharField(_('Paper ID'), blank=True, default='', max_length=10,
                                   help_text=_('PaperID for the CLIC CMT. This is a required field. One team per paper ID.'))
        def __str__(self):
